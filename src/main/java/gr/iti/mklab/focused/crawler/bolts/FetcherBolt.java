...
public class FetcherBolt extends BaseRichBolt {
	...
	public static final String MEDIA_STREAM = "media";
	public static final String WEBPAGE_STREAM = "webpages";
	...
	public FetcherBolt(int numOfFetchers) {
	...
	public void prepare(@SuppressWarnings("rawtypes") Map conf, TopologyContext context, 
		...
		_logger = Logger.getLogger(FetcherBolt.class);
